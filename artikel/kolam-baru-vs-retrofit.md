---
article_id: KID-02E
title: "Kolam Baru vs Retrofit: Data yang Harus Dikumpulkan dari Bangunan Eksisting"
slug: "kolam-baru-vs-retrofit"
description: "Identify drawings, structure, waterproofing, utilities, access, occupancy, hidden conditions, and investigation hold points"
status: outline
publication_date: "2025-06-14"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KID-02
primary_intent: "Scope investigation for an existing building"
reader_community: "Kolam.id"
reader_address: "Sobat Kolam.id"
final_route: "/artikel/kolam-baru-vs-retrofit.html"
...
# Kolam Baru vs Retrofit: Data yang Harus Dikumpulkan dari Bangunan Eksisting

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kolam Baru vs Retrofit: Data yang Harus Dikumpulkan dari Bangunan Eksisting”
- **Reader and situation:** Owner adding or modifying a pool
- **Reader outcome:** Identify drawings, structure, waterproofing, utilities, access, occupancy, hidden conditions, and investigation hold points
- **Primary intent:** Scope investigation for an existing building
...
- **Scope boundary:** Does not judge structural capacity; a licensed structural review is required, while KID-13F owns retrofit sequencing
- **Final public route:** `/artikel/kolam-baru-vs-retrofit.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kolam Baru vs Retrofit: Data yang Harus Dikumpulkan dari Bangunan Eksisting**.
...
- **Tie back to this article:** Keep the explanation specific to “Kolam Baru vs Retrofit: Data yang Harus Dikumpulkan dari Bangunan Eksisting”.
