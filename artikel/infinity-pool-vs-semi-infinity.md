---
article_id: KID-08D
title: "Infinity Pool vs Semi-Infinity: Bedanya Ada pada Edge, Hidraulik, dan Risiko Situs"
slug: "infinity-pool-vs-semi-infinity"
description: "Compare edge configuration, catchment, surge, wind, views, structure, water loss, maintenance, and failure consequences"
status: outline
publication_date: "2025-11-05"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KID-08
primary_intent: "Compare edge-pool concepts"
reader_community: "Kolam.id"
reader_address: "Kawan Kolam.id"
final_route: "/artikel/infinity-pool-vs-semi-infinity.html"
...
# Infinity Pool vs Semi-Infinity: Bedanya Ada pada Edge, Hidraulik, dan Risiko Situs

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Infinity Pool vs Semi-Infinity: Bedanya Ada pada Edge, Hidraulik, dan Risiko Situs”
- **Reader and situation:** Owner choosing a visual-edge format
- **Reader outcome:** Compare edge configuration, catchment, surge, wind, views, structure, water loss, maintenance, and failure consequences
- **Primary intent:** Compare edge-pool concepts
...
- **Scope boundary:** Does not size the hydraulic system; KID-04C owns skimmer/overflow mechanics and existing format routes own quotes
- **Final public route:** `/artikel/infinity-pool-vs-semi-infinity.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Infinity Pool vs Semi-Infinity: Bedanya Ada pada Edge, Hidraulik, dan Risiko Situs**.
...
- **Exact Markdown to insert:** `![Ilustrasi desain kolam renang semi infinity pool 7](/wp-content/uploads/2025/09/desain-kolam-renang-semi-infinity-pool-7.jpeg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `desain kolam renang semi infinity pool 7` as relevant content media; no pixels were inspected.
...
- **Tie back to this article:** Keep the explanation specific to “Infinity Pool vs Semi-Infinity: Bedanya Ada pada Edge, Hidraulik, dan Risiko Situs”.
