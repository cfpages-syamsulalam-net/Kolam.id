---
article_id: KID-03C
title: "Memilih Sistem Waterproofing Kolam Berdasarkan Substrat dan Detail"
slug: "memilih-waterproofing-kolam"
description: "Explain substrate readiness, positive/negative pressure, movement, compatibility, detailing, curing, and test evidence"
status: outline
publication_date: "2025-06-30"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KID-03
primary_intent: "Select a waterproofing strategy"
reader_community: "Kolam.id"
reader_address: "Sobat Kolam.id"
final_route: "/artikel/memilih-waterproofing-kolam.html"
...
# Memilih Sistem Waterproofing Kolam Berdasarkan Substrat dan Detail

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Memilih Sistem Waterproofing Kolam Berdasarkan Substrat dan Detail”
- **Reader and situation:** Designer/owner comparing product claims
- **Reader outcome:** Explain substrate readiness, positive/negative pressure, movement, compatibility, detailing, curing, and test evidence
- **Primary intent:** Select a waterproofing strategy
...
- **Scope boundary:** Does not prescribe one product or repair an existing leak; KID-13A owns diagnosis and manufacturer system data governs application
- **Final public route:** `/artikel/memilih-waterproofing-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memilih Sistem Waterproofing Kolam Berdasarkan Substrat dan Detail**.
...
- `KID-03A` → `/artikel/anatomi-struktur-kolam-beton.html` — Anatomi Struktur Kolam Beton: Shell, Tulangan, Sambungan, dan Penetrasi
...
- `KID-03D` → `/artikel/memilih-finishing-kolam.html` — Tile, Mosaic, Batu, atau Finishing Lain untuk Kolam: Pilih dari Pemakaian dan Perawatan
...
- **Tie back to this article:** Keep the explanation specific to “Memilih Sistem Waterproofing Kolam Berdasarkan Substrat dan Detail”.
